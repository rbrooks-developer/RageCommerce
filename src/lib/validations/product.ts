...
export const productSchema = z.object({
  ...
  length_in: z.number().positive("Length must be greater than 0"),
  width_in: z.number().positive("Width must be greater than 0"),
  height_in: z.number().positive("Height must be greater than 0"),
