...
export function Footer({
  ...
  return (
    ...
    >
      {/* Top rule */}
      <div className="h-px w-full" style={{ backgroundColor: fontColor, opacity: 0.15 }} />
        ...
        <div className="grid grid-cols-3 items-center gap-4">
          ...
          <div className="flex items-center">
            {logoUrl ? (
              ...
              <span className="text-base font-bold tracking-[0.3em] uppercase">{siteTitle}</span>
            )}
          </div>

          {/* ── Center: Name / tagline / contact / social ── */}
          <div className="flex flex-col items-center text-center">
            {/* Display name (e.g. owner name) */}
            <p
            ...
            {tagline && (
              <p
                ...
                style={{ letterSpacing: "0.3em", opacity: 0.6 }}
              >
                {tagline}
              </p>
            )}
            ...
            {(contactInfo?.phone || contactInfo?.email) && (
              <div className="mt-3 space-y-0.5 text-[10px]" style={{ opacity: 0.85 }}>
            ...
            {activeSocial.length > 0 && (
              <>
                <div
                  ...
                  style={{ backgroundColor: fontColor, opacity: 0.2 }}
                />
                <div className="flex items-center gap-2.5">
                  {activeSocial.map((s, i) => (
                    <span key={s.url} className="flex items-center gap-2.5">
                      <a
                        href={s.url}
                        target="_blank"
                      ...
                      {i < activeSocial.length - 1 && (
                        <span className="text-[10px]" style={{ opacity: 0.3 }}>|</span>
                      )}
                    </span>
                  ))}
                  {social_handle && (
                    <>
                      ...
                      <span
                        ...
                        style={{ letterSpacing: "0.2em", opacity: 0.65 }}
                      >
                        {social_handle}
                      </span>
                    </>
